...
const cases = [
  ...
  },
  {
    ...
    expected: 98,
    state: {
      concealedTiles: ['circle-6', 'circle-6', 'circle-6', 'dragon-red'],
      declaredSets: [
        ['flipped', 'bamboo-2', 'bamboo-2', 'flipped'],
        ['flipped', 'bamboo-7', 'bamboo-7', 'flipped'],
        ['flipped', 'wan-9', 'wan-9', 'flipped'],
      ],
      lastTileInGame: false,
      lastTileOfKind: false,
      prevalentWind: 'flipped',
  ...
  },
  {
    ...
    expected: 10,
    state: {
      concealedTiles: ['circle-4', 'circle-5', 'circle-3', 'circle-3'],
      declaredSets: [
        ['circle-4', 'circle-5', 'circle-6'],
        ['circle-6', 'circle-6', 'circle-6'],
  ...
  },
  {
    ...
    expected: 16,
    state: {
      concealedTiles: ['bamboo-8'],
      declaredSets: [
        ['bamboo-7', 'bamboo-7', 'bamboo-7'],
        ['dragon-white', 'dragon-white', 'dragon-white'],
        ['bamboo-2', 'bamboo-2', 'bamboo-2', 'bamboo-2'],
  ...
  },
  {
    ...
    state: {
      ...
      declaredSets: [['circle-1', 'circle-2', 'circle-3']],
      lastTileInGame: false,
      lastTileOfKind: false,
      prevalentWind: 'flipped',
      replacementTile: false,
  ...
  },
  {
    ...
    expected: 39,
    state: {
      concealedTiles: ['wan-2', 'wan-4', 'dragon-white', 'dragon-white'],
      declaredSets: [
        ['wan-3', 'wan-4', 'wan-5'],
        ['wan-4', 'wan-5', 'wan-6'],
        ['wan-5', 'wan-6', 'wan-7'],
  ...
  },
  {
    ...
    expected: 7,
    state: {
      concealedTiles: ['bamboo-5', 'bamboo-6', 'circle-5', 'circle-6', 'circle-7', 'wan-6', 'wan-6'],
      declaredSets: [
  ...
  },
  {
    ...
    expected: 36,
    state: {
      concealedTiles: ['bamboo-4', 'bamboo-5', 'bamboo-6', 'bamboo-6', 'bamboo-7', 'bamboo-8', 'circle-7'],
      declaredSets: [
        ['bamboo-5', 'bamboo-6', 'bamboo-7'],
        ['bamboo-7', 'bamboo-8', 'bamboo-9'],
      ],
  ...
  },
  {
    ...
    expected: 15,
    state: {
      concealedTiles: ['bamboo-1', 'bamboo-2', 'bamboo-3', 'bamboo-7'],
      declaredSets: [
        ['bamboo-1', 'bamboo-2', 'bamboo-3'],
        ['bamboo-7', 'bamboo-8', 'bamboo-9'],
        ['wan-7', 'wan-8', 'wan-9'],
  ...
  },
  {
    ...
    expected: 20,
    state: {
      concealedTiles: ['bamboo-2', 'bamboo-2', 'dragon-white', 'dragon-white'],
      declaredSets: [
        ['wan-1', 'wan-1', 'wan-1'],
        ['wan-4', 'wan-4', 'wan-4', 'wan-4'],
